...
class PolykeyClient {
  ...
  static async DeriveKey(
    request: pb.DeriveKeyMessage.AsObject
  ): Promise<boolean> {
  ...
  static async FindPeer(
    request: pb.ContactPeerMessage.AsObject
  ): Promise<boolean> {
  ...
  static async GetPeerInfo(
    peerId: string
  ): Promise<pb.PeerInfoMessage.AsObject> {
    const encodedRequest = new pb.StringMessage();
  ...
  static async PullVault(
    request: pb.VaultPathMessage.AsObject
  ): Promise<boolean> {
  ...
  static async UpdateLocalPeerInfo(
    request: pb.PeerInfoMessage.AsObject
  ): Promise<boolean> {
    const encodedRequest = new pb.PeerInfoMessage();
    encodedRequest.setPublicKey(request.publicKey);
    encodedRequest.setRootCertificate(request.rootCertificate);
